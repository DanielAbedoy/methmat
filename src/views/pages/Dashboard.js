            ...
            <Card>
              <CardBody className="display-flex">
                ...
                <div className="m-l">
                  ...
                  <p className="text-muted">
                    La libreria de JavaScript mas popular
                  </p>
                </div>
              </CardBody>
            </Card>
            ...
            <Card>
              <CardBody className="display-flex">
                ...
                <div className="m-l">
                  ...
                  <p className="text-muted">
                    El framewor para diseño preferido por la gente
                  </p>
                </div>
              </CardBody>
            </Card>
            ...
            <Card>
              <CardBody className="display-flex">
                ...
                <div className="m-l">
                  ...
                  <p className="text-muted">
                    El preprocesador css mas utilizado
                  </p>
                </div>
              </CardBody>
            </Card>
            ...
            <Card>
              <CardBody className="display-flex">
                ...
                <div className="m-l">
                  ...
                  <p className="text-muted">
                    Diseñodo tambien para dispositivos móviles
                  </p>
                </div>
              </CardBody>
            </Card>
